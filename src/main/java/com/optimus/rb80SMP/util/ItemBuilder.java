...
public class ItemBuilder {
    ...
    public ItemBuilder addEnchantmentGlint() {
        meta.addEnchant(Enchantment.getByKey(SMP.getPlugin().glow.getKey()), 1, true);
        item.setItemMeta(meta);
        return this;
    }

    public ItemBuilder removeEnchantmentGlint() {
        meta.removeEnchant(Enchantment.getByKey(SMP.getPlugin().glow.getKey()));
        item.setItemMeta(meta);
        return this;
    }
    ...
    public ItemBuilder setAttribute(Attribute attribute, AttributeModifier mod) {
